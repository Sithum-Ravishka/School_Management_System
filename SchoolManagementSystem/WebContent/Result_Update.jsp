...
<form action="update" id="form1" name="form1" method="post">
		...
		<table width="1095" border="0" align="center" cellpadding="0" cellspacing="10">
				<tbody>
						...
						<tr>
								<td><select name="classRoom" value="<%= classRoom %>" required="required" class="form-input">
										<option selected hidden value="">Select (Class)</option>
										<option value="6A">6A</option>
								</select></td>
								<td>&nbsp;</td>
								<td><select name="semester" value="<%= semester %>" required="required" class="form-input">
		...
		<table width="602" height="371" border="0" align="center" cellspacing="5">
				<tbody>
						...
						<tr>
								<td align="center"><select name="aestheticSubjects" value="<%= aestheticSubjects %>" id="Aestheticsubjects" class="form-input1" required="required" >
		...
		<table width="420" border="0" align="center">
				<tbody>
						<tr>
								<td width="140" align="center"><input type="submit" name="submit" value="Update My Data"></td>
						</tr>
				</tbody>
		</table>
		<p>&nbsp;</p>
