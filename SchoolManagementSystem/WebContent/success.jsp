            ...
            <tbody>
              <tr>
                <td width="183"><label for="textfield" class="lable">First</label>
                  <input name="textfield" type="text" required="required" id="textfield" value="${cus.fnm}"></td>
                <td width="194"><p>
                  <label for="textfield2" class="lable">Middle</label>
                  <input name="textfield2" type="text" required="required" id="textfield2" value="${cus.lnm}">
                  </p></td>
                <td width="181"><label for="textfield3" class="lable">Last</label>
                  <input type="text" name="textfield3" id="textfield3" value="${cus.mnm}"></td>
