...
<form action="reinsert" id="form1" name="form1" method="post">
		...
		<table width="241" border="0" align="left">
				<tbody>
						<tr>
								<td width="235" height="680" align="right"><img src="Image/123.jpg" width="181" height="670" alt=""/></td>
						</tr>
				</tbody>
		</table>
		<table width="216" height="689" border="0" align="right">
				<tbody>
						<tr>
								<td width="210" height="685"><img src="1.jpg" width="164" height="676" alt=""/></td>
						</tr>
				</tbody>
		</table>
		<p>&nbsp;</p>
		<table width="643" height="371" border="0" align="center" cellspacing="5">
				<tbody>
						<tr>
						...
						<tr>
								...
								<td align="center"><input name="grade" type="text" required="required" class="marks-input" id="grade" readonly="readonly" /></td>
						</tr>
						<tr>
								<td align="center">Avarage Mark</td>
								<td align="center"><input name="avarage" type="text" required="required" class="marks-input" id="avarage" readonly="readonly"/></td>
						</tr>
				</tbody>
		</table>
